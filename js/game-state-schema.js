...
(function(globalScope) {
    ...
    function validateGameStateData(gameState, limits) {
    ...
    function normalizeGameStateData(rawGameState) {
    ...
    function validateEnvelope(importData, limits) {
    ...
    function parseAndPrepareImport(fileText, limits) {
    ...
    globalScope.MirielsGameStateSchema = Object.freeze({
        formatName,
